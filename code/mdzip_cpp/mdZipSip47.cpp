...
// ================================
// global for the modulus exponent bitstream 
// need to refactor
...
int main (int argc, char **argv) {
     ...
     CLI::App app{"MDEncode MDzip Sip 40 C++ Program"};
     ...
     */
     ...
     // run mdzipfile
     mdzipfile(filename, blocksize, modsize, flcsvvals, blocklist, randombh, increment, decrement);
