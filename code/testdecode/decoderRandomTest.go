...
// project mdencode
// decoderRandomTest.go
//
// decoderRandomTest is a test program for the parallel modulus scan on a random generated byte block
//
// decoderRandomTest creates the byte block randomly with n-bytes and creates an n-bit modular floor
// decoderRandomTest will then run a parallel modulus scan to find the original n-byte block with a matching signature
// decoderRandomTest uses goroutines to run the scans in sequence and channels to communicate
//
