...
func argsSimple(argsNumber int) int {
	...
	if argsNumber == 1 { 
		...
		fmt.Println("md -file=Makefile -block=100 -bh=0 -fh=1 -format=19 -line=true")
		fmt.Println("md -file=Makefile -block=100 -bh=0 -fh=1111111 -format=19 -line=false")
		fmt.Println("md -file=Makefile -block=100 -bh=111 -fh=0 -format=19 -line")
		...
		fmt.Println("md -file=Makefile -block=100 -bh=10011101 -fh=11000111 -format=3000 -append=true -line=true -out=outputfile.inform")
